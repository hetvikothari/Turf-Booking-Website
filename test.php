  ...
  while($row = $result->fetch_assoc())
    {
      ...
      <tr id="number">
        ...
        <td><a href="removerow.php?id=<?php echo $id; ?>"><button id="number" name='delete' class="btnDelete" onclick="return confirm('Are you sure you want to delete this booking?');">DELETE</button></a></td>
      </tr>
  <?php
